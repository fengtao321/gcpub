...
export default function HomeComponent() {
  ...
  //         <p className="pagetag">
  //           Search our catalogue of over 566,500 publications. Access more than
  //           445,700 digital publications.
  //         </p>
  ...
  //                   defaultChecked={true}
  //                 />
  //                 <label htmlFor="ssti">Find variations of search terms</label>
  //               </div>
  //               <p>
