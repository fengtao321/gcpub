    ...
    <>
      ...
      <div className="row">
        <div className="col-md-6">
          <p className="pagetag">{t("home.pagetag")}</p>
            ...
            <form action="/eng/search/search.html" method="get">
              ...
              <fieldset>
                ...
                <div className="checkbox-inline mrgn-bttm-sm">
                  <input
                    ...
                    defaultChecked={true}
                  />
                  <label htmlFor="ssti">{t("home.find-variations")}</label>
                </div>
                <p>
                ...
                <div className="form-group mrgn-tp-md">
                  <label htmlFor="ast">
                    ...
                    <span className="small">
                      ...
                      author, department/agency) The AND operator is inserted by
                      default
                    </span>
                  </label>
                  <input
              ...
              <div className="checkbox-inline mrgn-tp-sm">
                <input
                  ...
                  defaultChecked={true}
                />
                <label htmlFor="adof">View electronic publications only</label>
              </div>
              <div className="text-right mrgn-tp-sm">
                <button type="submit" className="btn btn-primary mrgn-bttm-md">
                  Search
                </button>
              </div>
        ...
        <div className="col-md-6 hidden-sm hidden-xs">
          <div className="wb-tabs carousel-s2">
            {/* <ul role="tablist" aria-live="off">
              ...
              <li className="control  tab-count" tabIndex={0}>
                <div>
                  Item{" "}
                  <div className="curr-count">
                    <span className="curr-index">1</span> of 5
                  </div>
                </div>
              </li>
              <li className="control nxt">
                <a
                  className="nxt"
                  href="javascript:;"
                  role="button"
              ...
              <li className="control plypause">
                ...
                >
                  ...
                  <span>Play</span>
                  <span className="wb-inv"> - Start tab rotation</span>
                </a>
              </li>{" "}
            </ul> */}
            <ul role="tablist">
            ...
            <div className="tabpanels">
              <div role="tabpanel" className="in fade" id="20230914">
                <div className="panel panel-primary">
                  ...
                  <div className="panel-body">
                    <p>
                      From September 18 to 24, 2023, let’s celebrate the Science
                      Literacy Week under the theme of energy. Each year, this
                      week allows children and families to discover and
                      appreciate Canadian science in all its diversity. Consult
                      our publications to learn about Canada’s energy future and
                      the science and engineering promotion initiative.
                    </p>
                    ...
                    <ul className="text-center list-unstyled">
                      <li className="col-md-4">
                        ...
                        >
                          ...
                          />
                          <br />
                          Single-Use Plastics Prohibition Regulations: technical
                          guidelines
                        </a>
                      </li>
                      <li className="col-md-4">
              ...
              <div role="tabpanel" className="out fade" id="20230908">
                <div className="panel panel-primary">
                  ...
                  <div className="panel-body">
                    <p>
                      On September 8th, let’s celebrate Linguistic Duality Day.
                      In 2009, former Clerk of the Privy Council Wayne G.
                      ...
                      action plans, we invite you to consult these publications.
                    </p>
                    <ul className="text-center list-unstyled">
                      <li className="col-md-4">
                        <a
                      ...
                      <li className="col-md-4">
                        ...
                        >
                          ...
                          />
                          <br />
                          English and French: towards a substantive equality of
                      ...
                      <li className="col-md-4">
                        ...
                        >
                          ...
                          />
                          <br />
                          Summary document: engaging Canadians as a step towards
                    ...
                    <ul className="text-center list-unstyled">
                      ...
                      <li className="col-md-4">
                        ...
                        >
                          ...
                          campaign evaluation tool (ACET): methodological report
                        </a>
                      </li>
                      <li className="col-md-4">
                        <a
        ...
        <section className="col-md-8">
          ...
          <div className="row">
            ...
            <section className="col-md-6">
              ...
              <p>
                Learn about our history, our services and activities and how we
                fulfill our mandate
              </p>
            </section>
            <div className="clearfix"></div>
            <section className="col-md-6">
              ...
              <p>
                Reach Government of Canada Publications by contact form, phone,
                mail or email
              </p>
            </section>
          </div>
